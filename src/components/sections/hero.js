...
const Hero = () => {
  ...
  const two = <h2 className="big-heading">Dayron Hernandez.</h2>;
  const three = <h3 className="big-heading">Desarrollo 🚀 Sitios Web y Aplicaciónes Moviles.</h3>;
  const four = (
    <>
      <p>
  ...
  const five = (
    <a
      ...
      href="https://calendly.com/dayronzk/reunion"
      target="_blank"
      rel="noreferrer">
      Agenda Una Reunion
    </a>
