...
var GatsbyImageHydrator = /** @class */ (function (_super) {
    ...
    GatsbyImageHydrator.prototype._lazyHydrate = function (props, state) {
        ...
        return Promise.resolve().then(function () { return __importStar(require("./lazy-hydrate")); }).then(function (_a) {
            ...
            _this_1.lazyHydrator = lazyHydrate(__assign({ image: props.image.images, isLoading: state.isLoading || hooks_1.hasImageLoaded(cacheKey), isLoaded: state.isLoaded || hooks_1.hasImageLoaded(cacheKey), toggleIsLoaded: function () {
                    var _a;
